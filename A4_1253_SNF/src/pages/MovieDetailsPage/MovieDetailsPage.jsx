...
export default function MovieDetailsPage() {
  ...
  // BUG FIX (A4): Wrapped in useCallback to stabilize the reference.
  // Without it, a new function is created every render, causing the
  // overlay div to re-render unnecessarily.
