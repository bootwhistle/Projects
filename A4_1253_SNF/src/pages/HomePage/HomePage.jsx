...
export default function HomePage() {
  ...
  // ── Handlers ─────────────────────────────────────────────────────────────
  // BUG FIX (A4): All three handlers are now wrapped in useCallback.
  // Without useCallback, a new function reference is created on every render,
  // which defeats React.memo on SearchBar, GenreFilter, and MovieList —
  // they would re-render even when nothing relevant changed.
